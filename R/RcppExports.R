...
sample_sons_ages <- function(sons_configs_vec) {
    .Call('_copape_sample_sons_ages', PACKAGE = 'copape', sons_configs_vec)
}
...
#' 
#' @export
merge_pedigree <- function(pids, pids_dad, birthyears, paternalped_ids, pedid_to_merge, sons_configs, no_surrogate_ancestors = 1L, stop_birthyear = 1970L, force_surrogate_previous_to = 1900L, surr_pid_start = 50000000L, verbose = FALSE) {
    .Call('_copape_merge_pedigree', PACKAGE = 'copape', pids, pids_dad, birthyears, paternalped_ids, pedid_to_merge, sons_configs, no_surrogate_ancestors, stop_birthyear, force_surrogate_previous_to, surr_pid_start, verbose)
}
